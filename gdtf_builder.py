...
def build_gdtf(fixture_name, manufacturer, modes_dict, cell_count=1):
    """
    cell_count=1  -> single Body geometry (par, wash, strobe)
    cell_count>=2 -> pixel bar: Body with N GeometryReference children + Cell template
    MA3 treats each cell as a pixel-mappable element.
    """
